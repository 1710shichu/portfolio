...
$site_top = "http://shichu031710.xsrv.jp/emerald/";

//管理者のメールアドレス（送信先） ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "saitasaita0141sakura@gmail.com";
...
$from = "saitasaita0141sakura@gmial.com";
...
$thanksPage = "http://shichu031710.xsrv.jp/emerald/";
